...
router.post('/add', async (req, res) => {
  try {
    ...
    if (!nome || !carga_horaria) {
      return res.render('cursos/add', { error: 'Por favor, preencha todos os campos obrigatórios.' });
    }
...
router.put('/edit/:id', async (req, res) => {
  try {
    ...
    // Validação simples
    if (!nome || !carga_horaria) {
      return res.render('cursos/edit', { error: 'Por favor, preencha todos os campos obrigatórios.', curso: req.body });
    }

    await Curso.update({ nome, carga_horaria, descricao }, {
